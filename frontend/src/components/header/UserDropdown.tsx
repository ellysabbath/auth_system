...
export default function UserDropdown() {
  ...
  // Get profile picture URL or fallback to initials
    ...
    return (
      <div className="relative">
        <button className="flex items-center text-gray-700 dropdown-toggle dark:text-gray-400">
          ...
          <span className="block mr-1 font-medium text-theme-sm bg-gray-200 dark:bg-gray-700 w-20 h-4 animate-pulse rounded"></span>
        </button>
      </div>
    );
  }
      ...
      >
        <span className="mr-3 overflow-hidden rounded-full h-11 w-11">
          {getProfilePicture() ? (
            ...
            <div className="w-full h-full flex items-center justify-center bg-brand-500 text-white font-semibold text-lg">
              {getUserInitials()}
            </div>
          )}
        </span>
