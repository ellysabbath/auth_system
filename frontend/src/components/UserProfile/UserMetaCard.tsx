...
export default function UserMetaCard() {
  ...
  const { user, updateProfile, uploadProfilePicture, isLoading } = useUser();
  ...
  const getUserLocation = () => {
    ...
    if (user?.address?.country) return user.address.country;
            ...
            <div className="relative">
              <div className="w-20 h-20 overflow-hidden border border-gray-200 rounded-full dark:border-gray-800">
                {profilePreview ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center bg-brand-500 text-white text-2xl font-semibold">
                    {getUserInitials()}
                  </div>
                )}
              </div>
